...
def main(arguments):
    ...
    parser.add_argument('--store_name', help='store name prefix for current experiment', type=str, default='')
    ...
    parser.add_argument('--datatype', type=str, default='balanced', choices=['balanced', 'natural'])
    ...
    parser.add_argument('--loss', type=str, default='mse', choices=['bmse', 'mse', 'l1', 'focal_l1', 'focal_mse', 'huber'])
    ...
    elif args.regularization_type in ["scl"] or args.regularization_type in ["comp3"]:
        model = build_model_naivescl(args, vocab, word_embs, tasks)
    else:
